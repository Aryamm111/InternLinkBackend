...
public class ApplicationController {
    ...
    // // إنشاء طلب جديد
    // @PostMapping
    // public ResponseEntity<?> createApplication(@RequestBody Application
    // application) {
    ...
    // public ResponseEntity<?> updateApplicationStatus(@PathVariable String id,
    ...
    // return ResponseEntity.badRequest().body("Invalid status value. Use PENDING,
